...
wget https://github.com/ViRb3/wgcf/releases/download/v2.2.6/wgcf_2.2.6_linux_amd64 -O /etc/wireguard/wgcf_2.2.6_linux_amd64
cd /etc/wireguard && chmod +x wgcf_2.2.6_linux_amd64
echo 正在注册WARP账号. . .
echo yes | ./wgcf_2.2.6_linux_amd64 register
./wgcf_2.2.6_linux_amd64 generate
