...
cd /etc/wireguard && wget https://github.com/ViRb3/wgcf/releases/download/v2.2.8/wgcf_2.2.8_linux_amd64 -O /etc/wireguard/wgcf_2.2.8_linux_amd64
chmod +x wgcf_2.2.8_linux_amd64
echo 正在注册WARP账号. . .
